...
import {
  PublicationVisual,
  PublicationVisualAdapter,
} from './publication-visual.model';
...
export class VisualAdapter implements Adapter<Visual> {
  constructor(
    private publicationVisualAdapter: PublicationVisualAdapter,
    private fundingVisualAdapter: FundingVisualAdapter,
  ...
  adapt(
    ...
    return new Visual(publicationData, fundingData);
  }
}
