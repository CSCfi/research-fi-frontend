...
export class PublicationFilterService {
  filterData = [
    ...
    {field: 'publicationFormat', label: 'Julkaisumuoto', hasSubFields: false, open: false, tooltip: ''},
    {field: 'publicationAudience', label: 'Yleisö', hasSubFields: false, open: false, tooltip: ''},
    {field: 'parentPublicationType', label: 'Emojulkaisun tyyppi', hasSubFields: false, open: false, tooltip: ''},
    {field: 'peerReviewed', label: 'Vertaisarvioitu', hasSubFields: false, open: false, tooltip: ''},
