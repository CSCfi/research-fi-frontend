...
export class StaticDataService {
  ...
  visualisationData: {
    ...
    // tslint:disable-next-line: max-line-length
    publicationTooltipSv: '<ul><li>Efter du har valt ett tema för att visa antalet publikationer, kan du undersöka den årliga distributionen av publikationer enligt huvudvetenskapsområde, vetenskapsområde, organisation, publikationstyp, öppen tillgång, publiceringsland eller publikationsforumsnivå.</li><li><p class="d-inline">Från menyerna nedan kan du begränsa de publiceringsår, organisationer, vetenskapsområden osv. som du vill inkludera i antalet publikationer.</p><p class="mb-0">Använd menyerna nedan för att begränsa antalet publikationer som ska visas efter publiceringsår, organisationer, vetenskapsområden osv.</p></li><li>Obs. En publikation kan ha flera vetenskapsområden och organisationer. Publikationen visar i alla relaterade vetenskapsområden och organisationer när man begränser sökningen av vetenskapsområde eller organisation.</li><li>Siffrorna inkluderar publikationer i forskning.fi-tjänsten. Informationen uppdateras dagligen. Egentliga årliga statistiken om vetenskap och forskning hittar du både i avsnittet <a href=\"/science-innovation-policy/science-research-figures\">Siffror om vetenskap och forskning</a> och från utbildningsförvaltningens statistiktjänst <a href=\"https://vipunen.fi/sv-fi/h%C3%B6gskoleutbildning-och-fou-verksamhet\">Vipunen <i class="fas fa-external-link-alt"></i></a>.</li></ul>',
    // tslint:disable-next-line: max-line-length
