...
@Component({
  selector: 'app-filter-infrastructures',
  templateUrl: './filter-infrastructures.component.html',
  styleUrls: ['./filter-infrastructures.component.scss']
})
export class FilterInfrastructuresComponent implements OnInit, OnDestroy {
