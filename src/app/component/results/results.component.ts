...
import { publications, fundings, datasets, infrastructures, organizations, common } from 'src/assets/static-data/meta-tags.json';
...
export class ResultsComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  private metaTagsList = [publications, fundings, datasets, infrastructures, organizations];
