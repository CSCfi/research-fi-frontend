...
import { publications, fundings, infrastructures, organizations, common } from '@portal.assets/static-data/meta-tags.json';
import { Visual, VisualQuery } from '@portal.models/visualisation/visualisations.model';
